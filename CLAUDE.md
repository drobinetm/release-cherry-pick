...
- No lint/build tooling is configured (no ESLint/Prettier config present, despite AGENTS.md-generated output claiming ESLint conventions for target projects).
